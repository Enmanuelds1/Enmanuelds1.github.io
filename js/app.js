document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('data/products.json')
        ...
        .then(data => {
            ...
            displayProducts(data.cocinaElectrodomesticos, 'cocinaElectrodomesticos-products');
    ...
    orderForm.addEventListener('submit', (e) => {
        ...
        let message = `*NUEVO PEDIDO - BUTTERFLY CUBA*%0A%0A`;
